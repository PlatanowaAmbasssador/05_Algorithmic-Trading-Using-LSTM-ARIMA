...
df_SnP_ARIMA_LSTM_1 <- read.csv('../LSTM-ARIMA/Results/S&P500/Sensitivity Analysis/RANDOM_SEARCH_1/Visualisations/df_EC_LO_MAIN.csv')
df_SnP_ARIMA_LSTM_1 <- data.frame(Date = as.Date(df_SnP_ARIMA_LSTM_1$Date), Value = df_SnP_ARIMA_LSTM_1$strategy)

df_Benchmark_SnP <- read.csv('../LSTM-ARIMA/RESULTS/S&P500/Sensitivity Analysis/RANDOM_SEARCH_1/Visualisations/df_EC_LO_MAIN.csv')
...
df_SnP_ARIMA_LSTM_LS_1 <- read.csv('../LSTM-ARIMA/Results/S&P500/Sensitivity Analysis/RANDOM_SEARCH_1/Visualisations/df_EC_LS_MAIN.csv')
df_SnP_ARIMA_LSTM_LS_1 <- data.frame(Date = as.Date(df_SnP_ARIMA_LSTM_LS_1$Date), Value = df_SnP_ARIMA_LSTM_LS_1$strategy)

df_Benchmark_LS_1_SnP <- read.csv('../LSTM-ARIMA/Results/S&P500/Sensitivity Analysis/RANDOM_SEARCH_1/Visualisations/df_EC_LS_MAIN.csv')
...
df_FTSE_ARIMA_LSTM_1 <- read.csv('../LSTM-ARIMA/Results/FTSE100/Sensitivity Analysis/RANDOM_SEARCH_1A/Visualisations/df_EC_LO_MAIN.csv')
df_FTSE_ARIMA_LSTM_1 <- data.frame(Date = as.Date(df_FTSE_ARIMA_LSTM_1$Date), Value = df_FTSE_ARIMA_LSTM_1$strategy)

df_Benchmark_FTSE <- read.csv('../LSTM-ARIMA/RESULTS/FTSE100/Sensitivity Analysis/RANDOM_SEARCH_1A/Visualisations/df_EC_LO_MAIN.csv')
...
df_FTSE_ARIMA_LSTM_LS_1 <- read.csv('../LSTM-ARIMA/Results/FTSE100/Sensitivity Analysis/RANDOM_SEARCH_1A/Visualisations/df_EC_LS_MAIN.csv')
df_FTSE_ARIMA_LSTM_LS_1 <- data.frame(Date = as.Date(df_FTSE_ARIMA_LSTM_LS_1$Date), Value = df_FTSE_ARIMA_LSTM_LS_1$strategy)

df_Benchmark_LS_1_FTSE <- read.csv('../LSTM-ARIMA/Results/FTSE100/Sensitivity Analysis/RANDOM_SEARCH_1A/Visualisations/df_EC_LS_MAIN.csv')
...
df_CAC_ARIMA_LSTM_1 <- read.csv('../LSTM-ARIMA/Results/CAC/Sensitivity Analysis/RANDOM_SEARCH_1/Visualisations/df_EC_LO_MAIN.csv')
df_CAC_ARIMA_LSTM_1 <- data.frame(Date = as.Date(df_CAC_ARIMA_LSTM_1$Date), Value = df_CAC_ARIMA_LSTM_1$strategy)

df_Benchmark_CAC <- read.csv('../LSTM-ARIMA/RESULTS/CAC/Sensitivity Analysis/RANDOM_SEARCH_1/Visualisations/df_EC_LO_MAIN.csv')
...
df_CAC_ARIMA_LSTM_LS_1 <- read.csv('../LSTM-ARIMA/Results/CAC/Sensitivity Analysis/RANDOM_SEARCH_1/Visualisations/df_EC_LS_MAIN.csv')
df_CAC_ARIMA_LSTM_LS_1 <- data.frame(Date = as.Date(df_CAC_ARIMA_LSTM_LS_1$Date), Value = df_CAC_ARIMA_LSTM_LS_1$strategy)

df_Benchmark_LS_1_CAC <- read.csv('../LSTM-ARIMA/Results/CAC/Sensitivity Analysis/RANDOM_SEARCH_1/Visualisations/df_EC_LS_MAIN.csv')
...
\pagebreak
# SENSITIVITY ANALYSIS LSTM-ARIMA


```{r SENS LSTM-ARIMA, results='hide', fig.cap="LSTM-ARIMA Sensitivity Analysis for S&P 500", fig.width=10, fig.height=13}
#...... S&P 500 Long-Only ..........#

df_SnP_LSTM_1 <- read.csv('../LSTM-ARIMA/Results/S&P500/Sensitivity Analysis/RANDOM_SEARCH_1/Visualisations/df_EC_LO_MAIN.csv')
df_SnP_LSTM_1 <- data.frame(Date = as.Date(df_SnP_LSTM_1$Date), Value = df_SnP_LSTM_1$strategy)

df_Benchmark_SnP <- read.csv('../LSTM-ARIMA/RESULTS/S&P500/Sensitivity Analysis/RANDOM_SEARCH_1/Visualisations/df_EC_LO_MAIN.csv')
df_Benchmark_SnP <- data.frame(Date = as.Date(df_Benchmark_SnP$Date), Value = df_Benchmark_SnP$buy_n_hold)

df_SnP_LSTM_SENS_1 <- read.csv('../LSTM-ARIMA/Results/S&P500/Sensitivity Analysis/SENS_1/Visualisations/df_EC_LO_MAIN.csv')
df_SnP_LSTM_SENS_1 <- data.frame(Date = as.Date(df_SnP_LSTM_SENS_1$Date), Value = df_SnP_LSTM_SENS_1$strategy)

df_SnP_LSTM_SENS_1A <- read.csv('../LSTM-ARIMA/Results/S&P500/Sensitivity Analysis/SENS_1A/Visualisations/df_EC_LO_MAIN.csv')
df_SnP_LSTM_SENS_1A <- data.frame(Date = as.Date(df_SnP_LSTM_SENS_1A$Date), Value = df_SnP_LSTM_SENS_1A$strategy)
...
#...... S&P 500 Long-Short ..........#
df_SnP_LSTM_LS_1 <- read.csv('../LSTM-ARIMA/Results/S&P500/Sensitivity Analysis/RANDOM_SEARCH_1/Visualisations/df_EC_LS_MAIN.csv')
df_SnP_LSTM_LS_1 <- data.frame(Date = as.Date(df_SnP_LSTM_LS_1$Date), Value = df_SnP_LSTM_LS_1$strategy)

df_Benchmark_LS_1_SnP <- read.csv('../LSTM-ARIMA/Results/S&P500/Sensitivity Analysis/RANDOM_SEARCH_1/Visualisations/df_EC_LS_MAIN.csv')
df_Benchmark_LS_1_SnP <- data.frame(Date = as.Date(df_Benchmark_LS_1_SnP$Date), Value = df_Benchmark_LS_1_SnP$buy_n_hold)

df_SnP_LSTM_SENS_1_LS <- read.csv('../LSTM-ARIMA/Results/S&P500/Sensitivity Analysis/SENS_1/Visualisations/df_EC_LS_MAIN.csv')
df_SnP_LSTM_SENS_1_LS <- data.frame(Date = as.Date(df_SnP_LSTM_SENS_1_LS$Date), Value = df_SnP_LSTM_SENS_1_LS$strategy)

df_SnP_LSTM_SENS_1A_LS <- read.csv('../LSTM-ARIMA/Results/S&P500/Sensitivity Analysis/SENS_1A/Visualisations/df_EC_LS_MAIN.csv')
df_SnP_LSTM_SENS_1A_LS <- data.frame(Date = as.Date(df_SnP_LSTM_SENS_1A_LS$Date), Value = df_SnP_LSTM_SENS_1A_LS$strategy)
...
df_SnP_LSTM_SENS_2 <- read.csv('../LSTM-ARIMA/Results/S&P500/Sensitivity Analysis/SENS_2/Visualisations/df_EC_LO_MAIN.csv')
df_SnP_LSTM_SENS_2 <- data.frame(Date = as.Date(df_SnP_LSTM_SENS_2$Date), Value = df_SnP_LSTM_SENS_2$strategy)

df_SnP_LSTM_SENS_2A <- read.csv('../LSTM-ARIMA/Results/S&P500/Sensitivity Analysis/SENS_2A/Visualisations/df_EC_LO_MAIN.csv')
df_SnP_LSTM_SENS_2A <- data.frame(Date = as.Date(df_SnP_LSTM_SENS_2A$Date), Value = df_SnP_LSTM_SENS_2A$strategy)
...
df_SnP_LSTM_SENS_2_LS <- read.csv('../LSTM-ARIMA/Results/S&P500/Sensitivity Analysis/SENS_2/Visualisations/df_EC_LS_MAIN.csv')
df_SnP_LSTM_SENS_2_LS <- data.frame(Date = as.Date(df_SnP_LSTM_SENS_2_LS$Date), Value = df_SnP_LSTM_SENS_2_LS$strategy)

df_SnP_LSTM_SENS_2A_LS <- read.csv('../LSTM-ARIMA/Results/S&P500/Sensitivity Analysis/SENS_2A/Visualisations/df_EC_LS_MAIN.csv')
df_SnP_LSTM_SENS_2A_LS <- data.frame(Date = as.Date(df_SnP_LSTM_SENS_2A_LS$Date), Value = df_SnP_LSTM_SENS_2A_LS$strategy)
...
df_FTSE_LSTM_1 <- read.csv('../LSTM-ARIMA/Results/FTSE100/Sensitivity Analysis/RANDOM_SEARCH_1A/Visualisations/df_EC_LO_MAIN.csv')
df_FTSE_LSTM_1 <- data.frame(Date = as.Date(df_FTSE_LSTM_1$Date), Value = df_FTSE_LSTM_1$strategy)

df_Benchmark_FTSE <- read.csv('../LSTM-ARIMA/RESULTS/FTSE100/Sensitivity Analysis/RANDOM_SEARCH_1A/Visualisations/df_EC_LO_MAIN.csv')
df_Benchmark_FTSE <- data.frame(Date = as.Date(df_Benchmark_FTSE$Date), Value = df_Benchmark_FTSE$buy_n_hold)

df_FTSE_LSTM_SENS_1 <- read.csv('../LSTM-ARIMA/Results/FTSE100/Sensitivity Analysis/SENS_1/Visualisations/df_EC_LO_MAIN.csv')
df_FTSE_LSTM_SENS_1 <- data.frame(Date = as.Date(df_FTSE_LSTM_SENS_1$Date), Value = df_FTSE_LSTM_SENS_1$strategy)

df_FTSE_LSTM_SENS_1A <- read.csv('../LSTM-ARIMA/Results/FTSE100/Sensitivity Analysis/SENS_1A/Visualisations/df_EC_LO_MAIN.csv')
df_FTSE_LSTM_SENS_1A <- data.frame(Date = as.Date(df_FTSE_LSTM_SENS_1A$Date), Value = df_FTSE_LSTM_SENS_1A$strategy)
...
#...... FTSE 100 Long-Short ..........#
df_FTSE_LSTM_LS_1 <- read.csv('../LSTM-ARIMA/Results/FTSE100/Sensitivity Analysis/RANDOM_SEARCH_1A/Visualisations/df_EC_LS_MAIN.csv')
df_FTSE_LSTM_LS_1 <- data.frame(Date = as.Date(df_FTSE_LSTM_LS_1$Date), Value = df_FTSE_LSTM_LS_1$strategy)

df_Benchmark_LS_1_FTSE <- read.csv('../LSTM-ARIMA/Results/FTSE100/Sensitivity Analysis/RANDOM_SEARCH_1A/Visualisations/df_EC_LS_MAIN.csv')
df_Benchmark_LS_1_FTSE <- data.frame(Date = as.Date(df_Benchmark_LS_1_FTSE$Date), Value = df_Benchmark_LS_1_FTSE$buy_n_hold)

df_FTSE_LSTM_SENS_1_LS <- read.csv('../LSTM-ARIMA/Results/FTSE100/Sensitivity Analysis/SENS_1/Visualisations/df_EC_LS_MAIN.csv')
df_FTSE_LSTM_SENS_1_LS <- data.frame(Date = as.Date(df_FTSE_LSTM_SENS_1_LS$Date), Value = df_FTSE_LSTM_SENS_1_LS$strategy)

df_FTSE_LSTM_SENS_1A_LS <- read.csv('../LSTM-ARIMA/Results/FTSE100/Sensitivity Analysis/SENS_1A/Visualisations/df_EC_LS_MAIN.csv')
df_FTSE_LSTM_SENS_1A_LS <- data.frame(Date = as.Date(df_FTSE_LSTM_SENS_1A_LS$Date), Value = df_FTSE_LSTM_SENS_1A_LS$strategy)
...
df_FTSE_LSTM_SENS_2 <- read.csv('../LSTM-ARIMA/Results/FTSE100/Sensitivity Analysis/SENS_2/Visualisations/df_EC_LO_MAIN.csv')
df_FTSE_LSTM_SENS_2 <- data.frame(Date = as.Date(df_FTSE_LSTM_SENS_2$Date), Value = df_FTSE_LSTM_SENS_2$strategy)

df_FTSE_LSTM_SENS_2A <- read.csv('../LSTM-ARIMA/Results/FTSE100/Sensitivity Analysis/SENS_2A/Visualisations/df_EC_LO_MAIN.csv')
df_FTSE_LSTM_SENS_2A <- data.frame(Date = as.Date(df_FTSE_LSTM_SENS_2A$Date), Value = df_FTSE_LSTM_SENS_2A$strategy)
...
df_FTSE_LSTM_SENS_2_LS <- read.csv('../LSTM-ARIMA/Results/FTSE100/Sensitivity Analysis/SENS_2/Visualisations/df_EC_LS_MAIN.csv')
df_FTSE_LSTM_SENS_2_LS <- data.frame(Date = as.Date(df_FTSE_LSTM_SENS_2_LS$Date), Value = df_FTSE_LSTM_SENS_2_LS$strategy)

df_FTSE_LSTM_SENS_2A_LS <- read.csv('../LSTM-ARIMA/Results/FTSE100/Sensitivity Analysis/SENS_2A/Visualisations/df_EC_LS_MAIN.csv')
df_FTSE_LSTM_SENS_2A_LS <- data.frame(Date = as.Date(df_FTSE_LSTM_SENS_2A_LS$Date), Value = df_FTSE_LSTM_SENS_2A_LS$strategy)
...
df_CAC_LSTM_1 <- read.csv('../LSTM-ARIMA/Results/CAC/Sensitivity Analysis/RANDOM_SEARCH_1/Visualisations/df_EC_LO_MAIN.csv')
df_CAC_LSTM_1 <- data.frame(Date = as.Date(df_CAC_LSTM_1$Date), Value = df_CAC_LSTM_1$strategy)

df_Benchmark_CAC <- read.csv('../LSTM-ARIMA/RESULTS/CAC/Sensitivity Analysis/RANDOM_SEARCH_1/Visualisations/df_EC_LO_MAIN.csv')
df_Benchmark_CAC <- data.frame(Date = as.Date(df_Benchmark_CAC$Date), Value = df_Benchmark_CAC$buy_n_hold)

df_CAC_LSTM_SENS_1 <- read.csv('../LSTM-ARIMA/Results/CAC/Sensitivity Analysis/SENS_1/Visualisations/df_EC_LO_MAIN.csv')
df_CAC_LSTM_SENS_1 <- data.frame(Date = as.Date(df_CAC_LSTM_SENS_1$Date), Value = df_CAC_LSTM_SENS_1$strategy)

df_CAC_LSTM_SENS_1A <- read.csv('../LSTM-ARIMA/Results/CAC/Sensitivity Analysis/SENS_1A/Visualisations/df_EC_LO_MAIN.csv')
df_CAC_LSTM_SENS_1A <- data.frame(Date = as.Date(df_CAC_LSTM_SENS_1A$Date), Value = df_CAC_LSTM_SENS_1A$strategy)
...
#...... CAC 40 Long-Short ..........#
df_CAC_LSTM_LS_1 <- read.csv('../LSTM-ARIMA/Results/CAC/Sensitivity Analysis/RANDOM_SEARCH_1/Visualisations/df_EC_LS_MAIN.csv')
df_CAC_LSTM_LS_1 <- data.frame(Date = as.Date(df_CAC_LSTM_LS_1$Date), Value = df_CAC_LSTM_LS_1$strategy)

df_Benchmark_LS_1_CAC <- read.csv('../LSTM-ARIMA/Results/CAC/Sensitivity Analysis/RANDOM_SEARCH_1/Visualisations/df_EC_LS_MAIN.csv')
df_Benchmark_LS_1_CAC <- data.frame(Date = as.Date(df_Benchmark_LS_1_CAC$Date), Value = df_Benchmark_LS_1_CAC$buy_n_hold)

df_CAC_LSTM_SENS_1_LS <- read.csv('../LSTM-ARIMA/Results/CAC/Sensitivity Analysis/SENS_1/Visualisations/df_EC_LS_MAIN.csv')
df_CAC_LSTM_SENS_1_LS <- data.frame(Date = as.Date(df_CAC_LSTM_SENS_1_LS$Date), Value = df_CAC_LSTM_SENS_1_LS$strategy)

df_CAC_LSTM_SENS_1A_LS <- read.csv('../LSTM-ARIMA/Results/CAC/Sensitivity Analysis/SENS_1A/Visualisations/df_EC_LS_MAIN.csv')
df_CAC_LSTM_SENS_1A_LS <- data.frame(Date = as.Date(df_CAC_LSTM_SENS_1A_LS$Date), Value = df_CAC_LSTM_SENS_1A_LS$strategy)
...
df_CAC_LSTM_SENS_2 <- read.csv('../LSTM-ARIMA/Results/CAC/Sensitivity Analysis/SENS_2/Visualisations/df_EC_LO_MAIN.csv')
df_CAC_LSTM_SENS_2 <- data.frame(Date = as.Date(df_CAC_LSTM_SENS_2$Date), Value = df_CAC_LSTM_SENS_2$strategy)

df_CAC_LSTM_SENS_2A <- read.csv('../LSTM-ARIMA/Results/CAC/Sensitivity Analysis/SENS_2A/Visualisations/df_EC_LO_MAIN.csv')
df_CAC_LSTM_SENS_2A <- data.frame(Date = as.Date(df_CAC_LSTM_SENS_2A$Date), Value = df_CAC_LSTM_SENS_2A$strategy)
...
df_CAC_LSTM_SENS_2_LS <- read.csv('../LSTM-ARIMA/Results/CAC/Sensitivity Analysis/SENS_2/Visualisations/df_EC_LS_MAIN.csv')
df_CAC_LSTM_SENS_2_LS <- data.frame(Date = as.Date(df_CAC_LSTM_SENS_2_LS$Date), Value = df_CAC_LSTM_SENS_2_LS$strategy)

df_CAC_LSTM_SENS_2A_LS <- read.csv('../LSTM-ARIMA/Results/CAC/Sensitivity Analysis/SENS_2A/Visualisations/df_EC_LS_MAIN.csv')
df_CAC_LSTM_SENS_2A_LS <- data.frame(Date = as.Date(df_CAC_LSTM_SENS_2A_LS$Date), Value = df_CAC_LSTM_SENS_2A_LS$strategy)
